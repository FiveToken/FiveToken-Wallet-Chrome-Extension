<template>
    <div class="address-components">
        <div class="back-wrap">
            <ky-back :name="$t('sendFil.selectAddress')" @pageBack="back"/>
        </div>
        <div class="input-content">
            <div class="input-item">
                <ky-input :value="search" @changeInput="changeSearch" />
                <div class="search">
        ...
        <div class="select-wrap" v-else>
            <el-collapse :value="collapse">
                ...
                <el-collapse-item :title="$t('sendFil.myAccount')" name="2">
                    <div class="address-list" v-if="gettersAccountList">
                        <div class="address-item" v-for="(item,index) in gettersAccountList" :key="index" @click="addressClick(item,'myAccount')">
