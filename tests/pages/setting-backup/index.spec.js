...
import settingBack from '@/pages/setting-backups/component/index.vue'
...
describe('account index.vue', () => {
  ...
  const wrapper = shallowMount(settingBack, {
    store,
    localVue,
    data () {
      return {
  ...
  it('setting-backup.vue-test', async () => {
