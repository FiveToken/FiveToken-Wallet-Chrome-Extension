...
import settingAddress from '@/pages/setting-address/component/index.vue'
...
describe('account index.vue', () => {
  ...
  const wrapper = shallowMount(settingAddress, {
    store,
    localVue,
    i18n,
    data () {
  ...
  it('setting-address .vue-test', async () => {
    wrapper.vm.layoutMounted()
    wrapper.vm.addAddress()
    wrapper.vm.addEditAddressCb()
    wrapper.vm.deleteAddressCb()
  })
})
