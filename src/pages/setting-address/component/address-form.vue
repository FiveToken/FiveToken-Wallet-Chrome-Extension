...
export default {
    ...
    computed:{
        ...
        addDisabled(){
            ...
            console.log(values,values.every( n=> n !==''),"values.every( n=> n !=='')")
    ...
    methods:{
        ...
        confirmEdit(){
             window.filecoinwalletDb.addressBook.where("address").equals(this.detail.address).modify({address:this.edit.address,name:this.edit.name}).then(res=>{
