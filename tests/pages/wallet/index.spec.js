...
import KyHeader from '@/components/header/index'
import KyNetwork from '@/components/network/index'
...
localVue.use(KyHeader)
localVue.use(KyNetwork)
localVue.use(Vuex)
...
describe('account index.vue', () => {
  ...
  it('wallet .vue-test', async () => {
    wrapper.vm.networkChange()
    wrapper.vm.openNetwork()
    wrapper.vm.closeNetwork()
    wrapper.vm.maskClick()
