...
import customSend from '@/pages/custom-send-transaction/component/index.vue'
...
describe('account index.vue', () => {
  ...
  Object.defineProperty(window, 'location', {
    value: {
      href: './custom-send-transaction.html',
      search: '?'
    }
  })

  const wrapper = shallowMount(customSend, {
    store,
    localVue,
    data () {
      return {
  ...
  it('send-fil.vue-test', async () => {
    ...
    expect(href.indexOf('wallet')).not.toBe(-1)
  })
})
