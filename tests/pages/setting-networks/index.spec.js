...
import settingNetwotks from '@/pages/setting-networks/component/index.vue'
...
describe('set-netowrk index.vue', () => {
  ...
  const wrapper = shallowMount(settingNetwotks, {
    store,
    localVue,
    data () {
      return {
  ...
  it('set-netowrk .vue-test', async () => {
    ...
    wrapper.vm.deleteNetworkCb()

    wrapper.vm.addNetwork()

    wrapper.vm.networksItemClick(obj)

    wrapper.vm.addNetworkCb()
  })
})
