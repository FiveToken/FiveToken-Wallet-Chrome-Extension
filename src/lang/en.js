const zh = {
  ...
  createSuccess:{
    ...
    skillArr:[
      ...
      "Beware of phishing, Filecoin Wallet will never ask you for your personal account details",
      "If you need to back up your account helper again, please do so via Settings > Security Options."
    ],
    warn:'Filecoin Wallet cannot restore your recovery phrase.',
    btn:' All done'
  },
  wallet:{
    receive:'Receive',
    ...
    label:'Enter your Filecoin Wallet password',
  ...
  settingAbout:{
    about:'About',
    filVersion:'Filecoin Wallet Version',
    version:'1.0.0',
    tips:'Filecoin Wallet designed and developed by Singapore team',
    links:'Links',
  ...
  settingAddress:{
    name:'Name',
    filAddress:'Filecoin Wallet Address',
    ...
    cancel:'cancel',
    confirm:'confirm',
    placeholder:"Find Filecoin Wallet address, f0/f1/f2/f3 address",
    ...
    autoAdd:'All created Filecoin Wallet accounts will be automatically added to this section',
  ...
  connect:{
    title:'Connect using Filecoin Wallet',
    cancel:'Cancel',
    connect:'Connect'
  }
}
