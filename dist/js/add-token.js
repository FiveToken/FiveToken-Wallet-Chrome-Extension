...
/******/ 	deferredModules.push([40,"chunk-vendors"]);
...
/***/ "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/add-token/component/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _utils_abi__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @/utils/abi */ "./src/utils/abi.js");
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! vuex */ "./node_modules/vuex/dist/vuex.esm.js");
/* harmony import */ var _utils_local_store__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @/utils/local-store */ "./src/utils/local-store.js");
  ...
  methods: {
    layoutMounted: function layoutMounted() {
      ...
      return Object(_Users_zhupengcong_wallet_FiveToken_Wallet_Chrome_Extension_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var localStore, _tokenList, tokenList;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                localStore = new _utils_local_store__WEBPACK_IMPORTED_MODULE_15__["default"]();
                _this.localStore = localStore;
                _context.next = 4;
                return localStore.get('tokenList');

              case 4:
                _tokenList = _context.sent;

                if (_tokenList) {
                  tokenList = _tokenList.filter(function (n) {
                    return n.rpc === _this.rpc && n.address === _this.address;
                  });
    ...
    contractInput: function contractInput(val) {
      var _this2 = this;

      if (this.contract) {
        this.isFetch = true;

        var _contract = Object(_utils__WEBPACK_IMPORTED_MODULE_16__["trimStr"])(this.contract);

        var that = this;
        var isExists = this.tokenList.find(function (item) {
          return item.contract === _contract;
        }) !== undefined;
        this.isExists = isExists;
        var provider = ethers__WEBPACK_IMPORTED_MODULE_12__["ethers"].getDefaultProvider(this.rpc);
        var contract = new ethers__WEBPACK_IMPORTED_MODULE_12__["ethers"].Contract(_contract, _utils_abi__WEBPACK_IMPORTED_MODULE_13__["default"], provider);
        var decimalsPromise = contract.decimals();
        var namePromise = contract.name();
        var symbolPromise = contract.symbol();
        Promise.all([decimalsPromise, namePromise, symbolPromise]).then(function (values) {
          ...
          if (err && err.reason && err.reason.indexOf('resolver or addr is not configured for ENS name') > -1) {
            _this2.error = _this2.$t('addToken.addressError');
          } else {
            _this2.error = '';
          }
        });
    ...
    addContract: function addContract() {
      ...
      return Object(_Users_zhupengcong_wallet_FiveToken_Wallet_Chrome_Extension_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var _contract, allTokenList;

        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _contract = Object(_utils__WEBPACK_IMPORTED_MODULE_16__["trimStr"])(_this3.contract);

                if (!(_this3.contractEffective && !_this3.isExists)) {
                  _context2.next = 10;
                  break;
                }

                _context2.next = 4;
                return _this3.localStore.get('tokenList');
              ...
              case 7:
                allTokenList = _context2.t0;
                _context2.next = 10;
                return _this3.localStore.set({
                  tokenList: [].concat(Object(_Users_zhupengcong_wallet_FiveToken_Wallet_Chrome_Extension_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(allTokenList), [{
                    chainName: _this3.name,
                    decimals: _this3.decimals,
                    rpc: _this3.rpc,
...
/***/ "./node_modules/cache-loader/dist/cjs.js?{\"cacheDirectory\":\"node_modules/.cache/vue-loader\",\"cacheIdentifier\":\"a53c90b8-vue-loader-template\"}!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=template&id=b864a7ac&scoped=true&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"a53c90b8-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/add-token/component/index.vue?vue&type=template&id=b864a7ac&scoped=true& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function () {
  ...
  return _c("ky-layout", { on: { layoutMounted: _vm.layoutMounted } }, [
    _c("div", { staticClass: "add-token-page" }, [
      _c(
        "div",
        { staticClass: "back-wrap" },
        [
          _c("ky-back", {
            attrs: { name: _vm.$t("addToken.addToken") },
      ...
      _c("div", { staticClass: "add-content" }, [
        _c(
          ...
          [
            _c("div", { staticClass: "label" }, [
              _vm._v(_vm._s(_vm.$t("addToken.contractAddress"))),
            ]),
            _c("ky-input", {
              attrs: { value: _vm.contract },
              on: { changeInput: _vm.changeInput, blur: _vm.contractInput },
            }),
            _vm.isExists
              ? _c("div", { staticClass: "error" }, [
                  _vm._v(_vm._s(_vm.$t("addToken.error"))),
                ])
              : _vm._e(),
            _vm.error
              ? _c("div", { staticClass: "error" }, [
                  _vm._v(_vm._s(_vm.$t("addToken.addressError"))),
                ])
              : _vm._e(),
          ],
          1
        ),
        _vm.contractEffective
          ? _c("div", { staticClass: "info" }, [
              _c(
                "div",
                { staticClass: "logo" },
                [_c("ky-canvas", { attrs: { contract: _vm.contract } })],
                1
              ),
              ...
              _c("div", { staticClass: "info-item" }, [
                _c("div", { staticClass: "label" }, [
                  _vm._v(_vm._s(_vm.$t("addToken.token")) + ":"),
                ]),
                _c("div", { staticClass: "value" }, [
                  _c("div", { staticClass: "text" }, [
                    _vm._v(_vm._s(_vm.name)),
              ...
              _c("div", { staticClass: "info-item" }, [
                _c("div", { staticClass: "label" }, [
                  _vm._v(_vm._s(_vm.$t("addToken.tokenSymbol")) + ":"),
                ]),
                _c("div", { staticClass: "value" }, [
                  _c("div", { staticClass: "text" }, [
              ...
              _c("div", { staticClass: "info-item" }, [
                _c("div", { staticClass: "label" }, [
                  _vm._v(_vm._s(_vm.$t("addToken.decimalPoint"))),
                ]),
                _c("div", { staticClass: "value" }, [
                  _c("div", { staticClass: "text" }, [
                    _vm._v(_vm._s(_vm.decimals)),
                  ]),
                ]),
              ]),
            ])
      ...
      _c(
        ...
        [
          _c(
            ...
            {
              attrs: { type: "primary", active: _vm.active },
              on: { btnClick: _vm.addContract },
            },
            [_vm._v(" " + _vm._s(_vm.$t("addToken.addToken")) + " ")]
          ),
        ],
        1
      ),
...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js?!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--11-oneOf-1-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--11-oneOf-1-2!./node_modules/less-loader/dist/cjs.js??ref--11-oneOf-1-3!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".add-token-page[data-v-b864a7ac] {\n  width: 100%;\n  height: 100%;\n  background: #fff;\n  position: relative;\n}\n.add-token-page .back-wrap[data-v-b864a7ac] {\n  padding: 15px 20px;\n  border-bottom: 1px solid #f6f7ff;\n}\n.add-token-page .add-content[data-v-b864a7ac] {\n  padding: 20px;\n}\n.add-token-page .add-content .input-item[data-v-b864a7ac] {\n  margin-bottom: 30px;\n}\n.add-token-page .add-content .input-item .label[data-v-b864a7ac] {\n  color: #101010;\n  font-size: 14px;\n  line-height: 20px;\n  margin-bottom: 8px;\n}\n.add-token-page .add-content .input-item .error[data-v-b864a7ac] {\n  font-size: 12px;\n  color: #EA0F0F;\n  padding-top: 10px;\n}\n.add-token-page .add-content .info[data-v-b864a7ac] {\n  border: 1px solid #e6f0f0;\n  border-radius: 5px;\n}\n.add-token-page .add-content .info .logo[data-v-b864a7ac] {\n  margin: 20px auto;\n}\n.add-token-page .add-content .info .info-item[data-v-b864a7ac] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border-bottom: 1px solid #e6f0f0;\n  padding: 10px;\n}\n.add-token-page .add-content .info .info-item[data-v-b864a7ac]:last-child {\n  border-bottom: none;\n}\n.add-token-page .add-content .info .info-item .label[data-v-b864a7ac] {\n  font-size: 14px;\n  color: #737171;\n  line-height: 20px;\n  flex-shrink: 0;\n}\n.add-token-page .add-content .info .info-item .value[data-v-b864a7ac] {\n  padding-left: 20px;\n  flex-grow: 1;\n  display: flex;\n  justify-content: flex-end;\n}\n.add-token-page .add-content .info .info-item .value .text[data-v-b864a7ac] {\n  font-size: 14px;\n  color: #101010;\n  line-height: 20px;\n  word-break: break-all;\n  text-align: left;\n}\n.add-token-page .btn-wrap[data-v-b864a7ac] {\n  padding: 0 20px;\n  position: absolute;\n  width: 100%;\n  bottom: 20px;\n  left: 0;\n  box-sizing: border-box;\n}\n.add-token-page .loading[data-v-b864a7ac] {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background: rgba(0, 0, 0, 0.6);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 999;\n}\n.add-token-page .loading .img[data-v-b864a7ac] {\n  -webkit-animation: turnX-data-v-b864a7ac 3s linear infinite;\n          animation: turnX-data-v-b864a7ac 3s linear infinite;\n}\n@-webkit-keyframes turnX-data-v-b864a7ac {\n0% {\n    transform: rotateZ(0deg);\n}\n100% {\n    transform: rotateZ(360deg);\n}\n}\n@keyframes turnX-data-v-b864a7ac {\n0% {\n    transform: rotateZ(0deg);\n}\n100% {\n    transform: rotateZ(360deg);\n}\n}\n", ""]);
// Exports
module.exports = exports;
...
// load the styles
var content = __webpack_require__(/*! !../../../../node_modules/css-loader/dist/cjs.js??ref--11-oneOf-1-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--11-oneOf-1-2!../../../../node_modules/less-loader/dist/cjs.js??ref--11-oneOf-1-3!../../../../node_modules/cache-loader/dist/cjs.js??ref--1-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true& */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js?!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true&");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__(/*! ../../../../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js").default
var update = add("3b8c1fc4", content, false, {"sourceMap":false,"shadowMode":false});
// Hot Module Replacement
if(false) {}
...
/***/ "./src/pages/add-token/component/index.vue":
/*!*************************************************!*\
  !*** ./src/pages/add-token/component/index.vue ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_b864a7ac_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=b864a7ac&scoped=true& */ "./src/pages/add-token/component/index.vue?vue&type=template&id=b864a7ac&scoped=true&");
/* harmony import */ var _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js& */ "./src/pages/add-token/component/index.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _index_vue_vue_type_style_index_0_id_b864a7ac_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true& */ "./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _index_vue_vue_type_template_id_b864a7ac_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _index_vue_vue_type_template_id_b864a7ac_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "b864a7ac",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/pages/add-token/component/index.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/pages/add-token/component/index.vue?vue&type=script&lang=js&":
/*!**************************************************************************!*\
  !*** ./src/pages/add-token/component/index.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_cache_loader_dist_cjs_js_ref_13_0_node_modules_babel_loader_lib_index_js_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/cache-loader/dist/cjs.js??ref--13-0!../../../../node_modules/babel-loader/lib!../../../../node_modules/cache-loader/dist/cjs.js??ref--1-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=script&lang=js& */ "./node_modules/cache-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_cache_loader_dist_cjs_js_ref_13_0_node_modules_babel_loader_lib_index_js_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true&":
/*!***********************************************************************************************************!*\
  !*** ./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true& ***!
  \***********************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b864a7ac_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-style-loader??ref--11-oneOf-1-0!../../../../node_modules/css-loader/dist/cjs.js??ref--11-oneOf-1-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--11-oneOf-1-2!../../../../node_modules/less-loader/dist/cjs.js??ref--11-oneOf-1-3!../../../../node_modules/cache-loader/dist/cjs.js??ref--1-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true& */ "./node_modules/vue-style-loader/index.js?!./node_modules/css-loader/dist/cjs.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/less-loader/dist/cjs.js?!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=style&index=0&id=b864a7ac&lang=less&scoped=true&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b864a7ac_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b864a7ac_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b864a7ac_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_b864a7ac_lang_less_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./src/pages/add-token/component/index.vue?vue&type=template&id=b864a7ac&scoped=true&":
/*!********************************************************************************************!*\
  !*** ./src/pages/add-token/component/index.vue?vue&type=template&id=b864a7ac&scoped=true& ***!
  \********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_cache_loader_dist_cjs_js_cacheDirectory_node_modules_cache_vue_loader_cacheIdentifier_a53c90b8_vue_loader_template_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_b864a7ac_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"a53c90b8-vue-loader-template"}!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/cache-loader/dist/cjs.js??ref--1-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./index.vue?vue&type=template&id=b864a7ac&scoped=true& */ "./node_modules/cache-loader/dist/cjs.js?{\"cacheDirectory\":\"node_modules/.cache/vue-loader\",\"cacheIdentifier\":\"a53c90b8-vue-loader-template\"}!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/cache-loader/dist/cjs.js?!./node_modules/vue-loader/lib/index.js?!./src/pages/add-token/component/index.vue?vue&type=template&id=b864a7ac&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_cache_loader_dist_cjs_js_cacheDirectory_node_modules_cache_vue_loader_cacheIdentifier_a53c90b8_vue_loader_template_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_b864a7ac_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_cache_loader_dist_cjs_js_cacheDirectory_node_modules_cache_vue_loader_cacheIdentifier_a53c90b8_vue_loader_template_node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_b864a7ac_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./src/pages/add-token/index.js":
/*!**************************************!*\
  !*** ./src/pages/add-token/index.js ***!
  \**************************************/
/*! no exports provided */
...
/* harmony import */ var _component_index_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./component/index.vue */ "./src/pages/add-token/component/index.vue");
...
var KyLayout = _components_index_td__WEBPACK_IMPORTED_MODULE_17__["default"].KyLayout,
    ...
    KyCanvas = _components_index_td__WEBPACK_IMPORTED_MODULE_17__["default"].KyCanvas;
...
vue__WEBPACK_IMPORTED_MODULE_12__["default"].component(KyCanvas.name, KyCanvas);
...
/***/ 40:
/*!********************************************!*\
  !*** multi ./src/pages/add-token/index.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/zhupengcong/wallet/FiveToken-Wallet-Chrome-Extension/src/pages/add-token/index.js */"./src/pages/add-token/index.js");
...
/******/ });
//# sourceMappingURL=add-token.js.map